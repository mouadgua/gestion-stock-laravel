        ...
        <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-6">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="mt-2 text-xs text-gray-500">Formats : JPEG, PNG, GIF, WebP (max 2MB)</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" placeholder="Décrivez votre produit...">{{ old('description') }}</textarea>
                </div>
